...
CREATE TABLE "drivers" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "driver_id" varchar(100) UNIQUE NOT NULL DEFAULT ('DRV-' || substring(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE "customers" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "customer_id" varchar(100) UNIQUE NOT NULL DEFAULT ('CUST-' || substring(gen_random_uuid()::text, 1, 8)),
  "user_id" varchar(100) UNIQUE NOT NULL,
...
CREATE TABLE "addresses" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "address_id" varchar(100) UNIQUE NOT NULL DEFAULT ('ADDR-' || substring(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE "packages" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "package_id" varchar(100) UNIQUE NOT NULL DEFAULT ('PKG-' || substring(gen_random_uuid()::text, 1, 8)),
  "tracking_number" varchar(50) UNIQUE NOT NULL DEFAULT ('TRK-' || upper(substring(gen_random_uuid()::text, 1, 12))),
...
CREATE TABLE "deliveries" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "delivery_id" varchar(100) UNIQUE NOT NULL DEFAULT ('DEL-' || substring(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE "routes" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "route_id" varchar(100) UNIQUE NOT NULL DEFAULT ('RTE-' || substring(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE "route_stops" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "stop_id" varchar(100) UNIQUE NOT NULL DEFAULT ('STP-' || substring(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE "tracking_events" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "event_id" varchar(100) UNIQUE NOT NULL DEFAULT ('EVT-' || substring(gen_random_uuid()::text, 1, 8)),
  "package_id" varchar(100) NOT NULL,
...
CREATE TABLE "driver_locations" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "location_id" varchar(100) UNIQUE NOT NULL DEFAULT ('LOC-' || substring(gen_random_uuid()::text, 1, 8)),
  "driver_id" varchar(100) NOT NULL,
...
CREATE TABLE "payments" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "payment_id" varchar(100) UNIQUE NOT NULL DEFAULT ('PAY-' || substring(gen_random_uuid()::text, 1, 8)),
  "customer_id" varchar(100) NOT NULL,
  "delivery_id" varchar(100),
...
CREATE TABLE "pricing" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "pricing_id" varchar(100) UNIQUE NOT NULL DEFAULT ('PRC-' || substring(gen_random_uuid()::text, 1, 8)),
...
CREATE TABLE "ratings" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "rating_id" varchar(100) UNIQUE NOT NULL DEFAULT ('RAT-' || substring(gen_random_uuid()::text, 1, 8)),
  "delivery_id" varchar(100) NOT NULL,
...
CREATE TABLE "notifications" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "notification_id" varchar(100) UNIQUE NOT NULL DEFAULT ('NOTIF-' || substring(gen_random_uuid()::text, 1, 8)),
  "user_id" varchar(100) NOT NULL,
...
CREATE TABLE "vehicle_maintenance" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "maintenance_id" varchar(100) UNIQUE NOT NULL DEFAULT ('MAINT-' || substring(gen_random_uuid()::text, 1, 8)),
  "driver_id" varchar(100) NOT NULL,
...
RETURNS TRIGGER AS $driver_rating$
DECLARE
...
BEGIN
    ...
    RETURN NEW;
END;
$driver_rating$ LANGUAGE plpgsql;
...
RETURNS TRIGGER AS $cust_totals$
BEGIN
    UPDATE customers
    SET 
        total_orders = (
...
BEGIN
    ...
    RETURN R * c;
END;
$calc_dist$ LANGUAGE plpgsql IMMUTABLE;
